...
const View2 = () => {
    ...
    const baseURL = 'https://puasa23.000webhostapp.com/zkoolday_avif/';
  
    // Array yang berisi nama-nama file gambar dari '1.png' hingga '53.png'
    const imageNames = Array.from({ length: 125 }, (_, index) => `${index + 1}.avif`);
    ...
    return (
      <div className="flex z-100 keydown flex-col lg:flex-row h-screen" onContextMenu={handleContextMenu}>
               <svg x="50%" y={0} className="overflow-visible -z-50 rounded-xl absolute opacity-45 fill-fuchsia-500">
    <path
    ...
    />
        ...
        <div className="lg:w-1/2 p-8 flex flex-col items-center justify-center">
          <img src="https://puasa23.000webhostapp.com/info/olday.png" className="mb-5 w-48 sm:w-auto" alt="" srcset="" /> {/* Menambahkan kelas responsif untuk gambar */}
          <h1 className="mb-12 font-semibold text-3xl lg:text-4xl xl:text-5xl">GET A DZOOLAY</h1>
          <div className="flex">
